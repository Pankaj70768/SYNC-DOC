    ...
    <main className="min-h-screen overflow-hidden bg-[#f7f8fc] text-slate-900">
      ...
      <nav className="relative z-10 mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-6 lg:px-8">
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-slate-950 text-lg font-bold text-white shadow-lg shadow-slate-900/20">
            S
          </div>
        ...
        <button className="rounded-xl bg-slate-950 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-slate-900/20 transition hover:-translate-y-0.5 hover:bg-slate-800">
          Get Started
        </button>
      </nav>
        ...
        <div className="grid w-full items-center gap-16 lg:grid-cols-2">
          ...
          <div className="max-w-2xl">
            ...
            <div className="mt-9 flex flex-col gap-4 sm:flex-row">
              <button className="rounded-2xl bg-slate-950 px-7 py-4 text-sm font-semibold text-white shadow-xl shadow-slate-900/20 transition hover:-translate-y-1 hover:bg-slate-800">
                Start Writing →
              </button>

              <button className="rounded-2xl border border-slate-200 bg-white px-7 py-4 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-slate-300 hover:bg-slate-50">
                Explore Workspace
              </button>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/70 bg-white shadow-2xl shadow-slate-300/40">
              {/* Editor top bar */}
              <div className="flex items-center justify-between border-b border-slate-100 px-6 py-4">
                ...
                <div className="rounded-lg bg-slate-100 px-3 py-1 text-xs font-medium text-slate-500">
                  Synced just now
                </div>
              </div>
            ...
            <div className="absolute -bottom-6 -left-5 rounded-2xl border border-white bg-white px-4 py-3 shadow-xl shadow-slate-300/30">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">Everything is synced</p>
                </div>
              </div>
            </div>
          </div>
